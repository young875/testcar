 ...
 */
final class Version20200114090511 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cars (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, chevaux INT NOT NULL, version VARCHAR(255) NOT NULL, puissance INT NOT NULL, co2 INT NOT NULL, porte INT NOT NULL, prix DOUBLE PRECISION NOT NULL, annee INT NOT NULL, kilometre INT NOT NULL, publie TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE marques (id INT AUTO_INCREMENT NOT NULL, filename VARCHAR(255) NOT NULL, marque VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
